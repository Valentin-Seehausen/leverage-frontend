<div class="text-center py-20 mt-20">
	...
	<p class="mt-6 leading-8 dark:text-slate-400">
		Open Currency Technology Seehausen UG operates the https://hyperbolic.trade website, which
	...
	<p class="mt-6 leading-8 dark:text-slate-400">
		...
		which is accessible at https://hyperbolic.trade, unless otherwise defined in this Privacy
		Policy.
	</p>

	<h2 class="text-xl mt-6 font-bold tracking-tight dark:text-slate-100 sm:text-l">
	...
	<h2 class="text-xl mt-6 font-bold tracking-tight dark:text-slate-100 sm:text-l">Log Data</h2>
	...
	<h2 class="text-xl mt-6 font-bold tracking-tight dark:text-slate-100 sm:text-l">Cookies</h2>
	...
	<h2 class="text-xl mt-6 font-bold tracking-tight dark:text-slate-100 sm:text-l">Security</h2>
	...
	<p class="mt-6 leading-8 dark:text-slate-400">Children's Privacy</p>
	...
	<p class="mt-6 leading-8 dark:text-slate-400">
		Our Privacy Policy was created with the help of the <a
			href="https://www.privacypolicytemplate.net">Privacy Policy Template</a
		>.
	</p>

	<h2 class="text-xl mt-6 font-bold tracking-tight dark:text-slate-100 sm:text-l">Contact Us</h2>
