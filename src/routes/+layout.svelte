...
>
	...
	<main class="min-h-screen isolate pb-24">
		...
		<div class="fixed inset-x-0 -z-10 transform-gpu blur-3xl sm:-top-80" aria-hidden="true">
			<div
				class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary-600 to-valhalla-700 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
		...
		<div class="fixed inset-x-0 -z-10 transform-gpu blur-3xl sm:-bottom-80" aria-hidden="true">
			<div
				class="relative right-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] translate-x-1/2 rotate-[60deg] bg-gradient-to-tr from-primary-400 to-valhalla-400 opacity-30 sm:right-[calc(50%-30rem)] sm:w-[72.1875rem]"
				style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
			/>
		</div>
		<div class="">
	...
	<footer
		class="info-label isolate text-xs text-center py-12 pb-24 md:pb-12 dark:bg-valhalla-900 font-light dark:text-valhalla-100/50 border-t dark:border-valhalla-700"
	>
