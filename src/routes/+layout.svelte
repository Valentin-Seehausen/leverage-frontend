...
>
	<div class="max-w-screen-lg m-auto">
		...
		<p class="mt-6">
			...
			the website's content as such. Hyperbolic Trading does not recommend that any cryptocurrency should
			be bought, sold, or held by you. Always conduct your own due diligence before making any investment
			decisions. Hyperbolic Trading is governed by a Decentralized Autonomous Organization (DAO), which
			ensures the protocol operates in a decentralized and democratic manner. However, being a DAO does
			not exempt users from their individual responsibilities. All users are expected to be responsible
			and cautious in their trading activities.
		</p>
